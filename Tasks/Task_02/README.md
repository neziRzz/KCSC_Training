...
; Initialize and dynamically resolve MsgBox
    ...
    push edx
    push "DDDX" ; little endian so string must be reversed
    mov edi, esp
    push edx
    push "ugn"
    mov ecx, esp
...
```
- Dump bytecode của chương trình vừa được compiled và chạy shellcode với loader dưới đây
```C
#include <windows.h>
#include <stdio.h>
unsigned char MsgBox_shellcode[] =
{
  ,
  ...
  0x61, 0x66, 0x83, 0x6C, 0x24, 0x03, 0x61, 0x68, 0x61, 0x67,
  0x65, 0x42, 0x68, 0x4D, 0x65, 0x73, 0x73, 0x54, 0x50, 0xFF,
  0xD5, 0x83, 0xC4, 0x10, 0x33, 0xD2, 0x33, 0xC9, 0x52, 0x68,
  0x58, 0x44, 0x44, 0x44, 0x8B, 0xFC, 0x52, 0x68, 0x6E, 0x67,
  0x75, 0x00, 0x8B, 0xCC, 0x52, 0x57, 0x51, 0x52, 0xFF, 0xD0,
  0x83, 0xC4, 0x10, 0x68, 0x65, 0x73, 0x73, 0x61, 0x66, 0x83,
  0x6C, 0x24, 0x03, 0x61, 0x68, 0x50, 0x72, 0x6F, 0x63, 0x68,
  0x45, 0x78, 0x69, 0x74, 0x54, 0x53, 0xFF, 0xD5, 0x33, 0xC9,
  0x51, 0xFF, 0xD0
};
int main() {
...
```
- Và shellcode chạy thành công

![image](https://github.com/user-attachments/assets/c2744075-e6a1-4d5b-8452-8ef88104c02a)
